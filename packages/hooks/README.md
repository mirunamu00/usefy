...
> ✅ **Stable & production-ready** — `@usefy/hooks` follows [semantic versioning](https://semver.org); breaking changes only ever land in a new major version.
>
> 🚧 **Actively developing**: new hooks are added regularly, and the umbrella re-exports every one.
...
| <a href="https://www.npmjs.com/package/@usefy/use-previous" target="_blank" rel="noopener noreferrer">@usefy/use-previous</a> | Previous distinct value (last render it changed) | <a href="https://www.npmjs.com/package/@usefy/use-previous" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/npm/v/@usefy/use-previous.svg?style=flat-square&color=007acc" alt="npm version" /></a> | ![100%](https://img.shields.io/badge/coverage-100%25-brightgreen?style=flat-square) |
...
<details>
<summary><strong>usePrevious</strong> — Previous distinct value (last render it changed)</summary>
