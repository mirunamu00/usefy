---
"@usefy/use-mutation-observer": minor
"@usefy/hooks": minor
---

Add `@usefy/use-mutation-observer` — a React hook wrapping the DOM `MutationObserver` API to watch an element for child, attribute, and character-data mutations.
