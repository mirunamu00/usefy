---
"@usefy/use-user-media": minor
---

Add `@usefy/use-user-media` — camera and microphone streams, with a teardown you can rely on
...
- **Every track is stopped** on unmount, on `stop()`, and when a stream is
  replaced — including a stream that arrives *after* the component unmounted,
